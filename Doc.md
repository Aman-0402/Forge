...
| Exams | `question-banks/` (+`import/`) · `question-banks/{id}/questions/` · `questions/{id}/` · `exams/` · `exams/{id}/questions/` (+`{row}/`) · `exams/{id}/schedule|unschedule|extend|close|release-results/` · `exams/{id}/start/` · `attempts/{id}/` · `attempts/{id}/answers/{exam_question_id}/` · `attempts/{id}/submit/` · `attempts/{id}/integrity-events/` · `exams/{id}/attempts/` · `attempts/{id}/review/` · `answers/{id}/grade/` · `attempts/{id}/result/` · `exams/{id}/results/` (+`export/`) · `me/results/` |
| Coding | `languages/` · `problems/` (+`publish|unpublish|archive/`) · `problems/{id}/testcases/` (+`import/`) · `testcases/{id}/` · `problems/{id}/run/` (samples or custom input, not stored) · `problems/{id}/submit/` · `problems/{id}/submissions/` · `code-submissions/{id}/` · `problems/{id}/rejudge/` · `problems/{id}/leaderboard/` · `me/coding/summary/` |
